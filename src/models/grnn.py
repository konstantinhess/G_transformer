...
class GRNN(TimeVaryingCausalModel):
    """
    Pytorch-Lightning implementation of G-Transformer (GRNN)
    """

    model_type = 'grnn'  # multi-input model
    possible_model_types = {'grnn'}
    ...
    def __init__(self, args: DictConfig,
        ...
        elif args.model.grnn.projection_horizon is not None:
            self.projection_horizon = args.model.grnn.projection_horizon
        ...
        self.input_size = sum((self.dim_treatments, self.dim_static_features, self.dim_vitals, self.dim_outcome))
